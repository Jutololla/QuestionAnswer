...
public class SubtractAnswerVoteUseCase {
    ...
    public SubtractAnswerVoteUseCase(AnswerRepository answerRepository, MapperUtils mapperUtils,
                                     GetAnswerUseCase getAnswerUseCase, DeleteVoteUseCase deleteVoteUseCase) {
